!(function (t) {
  'function' == typeof define && define.amd
    ? define(['jquery', 'codemirror'], t)
    : t(window.jQuery, window.CodeMirror)
})(function (t, e) {
  'function' != typeof Array.prototype.reduce &&
    (Array.prototype.reduce = function (t, e) {
      var n,
        a,
        o = this.length >>> 0,
        i = !1
      for (1 < arguments.length && ((a = e), (i = !0)), n = 0; o > n; ++n)
        this.hasOwnProperty(n) &&
          (i ? (a = t(a, this[n], n, this)) : ((a = this[n]), (i = !0)))
  ...
  var n = {
    ...
    a = (function () {
      ...
      return { eq: t, eq2: e, fail: n, not: a, self: o }
    })(),
    o = (function () {
      var t = function (t) {
          return t[0]
    ...
    i = (function () {
      var e = function (t) {
        ...
        f = function (e, n) {
          for (var a = u(e), o = n; o; o = o.parentNode)
            if (t.inArray(o, a) > -1) return o
          return null
        },
        h = function (t, e) {
          var n = [],
            ...
            i = function (r) {
              if (r) {
                if ((r === t && (a = !0), a && !o && n.push(r), r === e))
                  return void (o = !0)
                for (var l = 0, s = r.childNodes.length; s > l; l++)
                  i(r.childNodes[l])
              }
            }
          return i(f(t, e)), n
        ...
        C = function (t, e) {
          for (var n = t, a = 0, o = e.length; o > a; a++)
            n = n.childNodes[e[a]]
          return n
        },
        x = function (t, e) {
          ...
          if (t && t.parentNode) {
            ...
            if (!e) {
              var a,
                o,
                i = []
              for (a = 0, o = t.childNodes.length; o > a; a++)
                i.push(t.childNodes[a])
      ...
      var e = !!document.createRange,
        n = function (t, e) {
          ...
          for (n = 0; n < s.length; n++)
            if (!i.isText(s[n])) {
              if (
                (l.moveToElementText(s[n]),
                l.compareEndPoints('StartToStart', t) >= 0)
              )
                break
              a = s[n]
            }
          if (0 !== n && i.isText(s[n - 1])) {
            var d = document.body.createTextRange(),
              c = null
            d.moveToElementText(a || r),
              d.collapse(!a),
              (c = a ? a.nextSibling : r.firstChild)
            var u = t.duplicate()
            u.setEndPoint('StartToStart', d)
            for (
              var f = u.text.replace(/[\r\n]/g, '').length;
              f > c.nodeValue.length && c.nextSibling;

            )
              (f -= c.nodeValue.length), (c = c.nextSibling)
            {
              c.nodeValue
            }
            e &&
              c.nextSibling &&
              i.isText(c.nextSibling) &&
              f === c.nodeValue.length &&
              ((f -= c.nodeValue.length), (c = c.nextSibling)),
              (r = c),
              (n = f)
          }
          return { cont: r, offset: n }
        },
        r = function (t) {
          var e = function (t, n) {
              var r, l
              if (i.isText(t)) {
                ...
                ;(r = d || t.parentNode),
                  (n += o.sum(o.tail(s), i.length)),
                  (l = !d)
              } else {
                if (((r = t.childNodes[n] || t), i.isText(r))) return e(r, n)
                ;(n = 0), (l = !1)
              }
              return { cont: r, collapseToStart: l, offset: n }
            },
            n = document.body.createTextRange(),
            r = e(t.cont, t.offset)
          return (
            n.moveToElementText(r.cont),
        ...
        l = function (n, l, s, d) {
          ...
          var c = function () {
            ...
            var a = r({ cont: n, offset: l })
            return a.setEndPoint('EndToEnd', r({ cont: s, offset: d })), a
          }
          ...
          ;(this.isOnEditable = u(i.isEditable)),
            (this.isOnList = u(i.isList)),
            (this.isOnAnchor = u(i.isAnchor)),
            ...
            (this.bookmark = function (t) {
              return {
                s: { path: i.makeOffsetPath(t, n), offset: l },
                e: { path: i.makeOffsetPath(t, s), offset: d }
              }
            })
        }
      return {
    ...
    s = function () {
      ;(this.stylePara = function (e, n) {
        ...
        (this.current = function (e, n) {
          ...
          if (
            ((o['font-size'] = parseInt(o['font-size'])),
          ...
          return (
            (o.image = i.isImg(n) && n),
            (o.anchor = e.isOnAnchor() && i.ancestor(e.sc, i.isAnchor)),
            (o.aAncestor = i.listAncestor(e.sc, i.isEditable)),
            o
          )
        })
    },
    d = function () {
      var t = [],
        ...
        a = function (t, e) {
          t.html(e.contents).scrollTop(e.scrollTop),
            r.createFromBookmark(t[0], e.bookmark).select()
        }
    ...
    c = function () {
      ...
      for (
        var a = (this.recordUndo = function (t) {
      ...
      ;(this.insertImage = function (e, n) {
        l.loadImage(n)
          .done(function (o) {
            ...
            i.css('width', Math.min(e.width(), o.width)),
              r.create().insertNode(i[0])
          })
          .fail(function () {
        ...
        (this.insertVideo = function (e, n) {
          ...
          if (i && 11 === i[2].length) {
            var v = i[2]
            a = t('<iframe>')
              .attr('src', 'http://www.youtube.com/embed/' + v)
              .attr('width', '640')
              .attr('height', '360')
          } else
            s && s[0].length > 0
              ...
              ? (a = t(
                  ...
                  .attr('src', '//player.vimeo.com/video/' + f[3])
                  .attr('width', '640')
                  .attr('height', '360'))
              : b &&
                b[2].length > 0 &&
                (a = t('<iframe>')
                  .attr('src', 'http://www.dailymotion.com/embed/video/' + b[2])
                  .attr('width', '640')
                  .attr('height', '360'))
        ...
        (this.lineHeight = function (t, n) {
          a(t), e.stylePara(r.create(), { lineHeight: n })
        }),
        ...
        (this.setVideoDialog = function (t, e) {
          ...
          e({ range: n, text: n.toString() }, function (e) {
        ...
        (this.resizeTo = function (t, e) {
          var n = t.y / t.x,
            a = e.data('ratio')
          e.css({ width: a > n ? t.x : t.y / a, height: a > n ? t.x * a : t.y })
        })
    },
    u = function () {
      ;(this.update = function (e, n) {
        ...
        o.find('.note-current-fontsize').html(n['font-size']),
          a(o, parseFloat(n['font-size']))
    ...
    f = function () {
      var e = function (e, n) {
        var a = t(n),
          o = a.position(),
          i = a.height()
        e.css({ display: 'block', left: o.left, top: o.top + i })
      }
      ...
      ;(this.showImageDialog = function (n, a, o) {
        ...
        i.on('shown.bs.modal', function () {
          r.on('change', function () {
            a(this.files), t(this).val(''), i.modal('hide')
          }),
            l
              .val('')
              .keyup(function () {
          ...
          .on('hidden.bs.modal', function () {
            r.off('change'),
              i.off('shown.bs.modal hidden.bs.modal'),
              l.off('keyup'),
              s.off('click')
          })
          .modal('show')
        ...
        (this.showVideoDialog = function (t, n, a) {
          ...
          o.on('shown.bs.modal', function () {
            ...
            .on('hidden.bs.modal', function () {
              i.off('keyup'),
                r.off('click'),
                o.off('show.bs.modal hidden.bs.modal')
            })
            .modal('show')
        }),
        (this.showLinkDialog = function (t, n, a) {
          ...
          o.on('shown.bs.modal', function () {
            ...
            .on('hidden.bs.modal', function () {
              r.off('keyup'),
                l.off('click'),
                o.off('shown.bs.modal hidden.bs.modal')
            })
            .modal('show')
        }),
    ...
    v = function () {
      var a = new c(),
        ...
        g = function (t) {
          ...
          if (i === v.TAB && l.editable().data('tabsize')) a.tab(l.editable())
            ...
            l.editable(),
              a.setLinkDialog(l.editable(), function (t, e) {
            ...
            if (!e || i !== v.ENTER)
              return void (
                (i === v.BACKSPACE || i === v.ENTER || i === v.SPACE) &&
                a.recordUndo(m(t.target).editable())
              )
        ...
        w = function (t) {
          ...
          n &&
            (o.update(e.toolbar(), n),
            r.update(e.popover(), n),
            s.update(e.handle(), n))
        },
        C = function (t) {
          var e = m(t.currentTarget || t.target)
          ...
          if (i.isControlSizing(e.target)) {
            ...
            u
              .on('mousemove', function (t) {
                ;(n = { x: t.clientX - b.left, y: t.clientY - (b.top - v) }),
                  a.resizeTo(n, h),
                  s.update(l, { image: f }),
                  r.update(d, { image: f })
              })
              ...
              h.data('ratio') || h.data('ratio', h.height() / h.width()),
              a.recordUndo(c),
              e.stopPropagation(),
              e.preventDefault()
          }
        ...
        S = function (r) {
          ...
          if (l.length > 0) {
            ...
            if (
              (a[c] && (g.trigger('focus'), a[c](g, u, s)),
              -1 !== t.inArray(c, ['backColor', 'foreColor']))
            )
              o.updateRecentColor(l[0], c, u)
            else if ('showLinkDialog' === c)
              g.focus(),
                a.setLinkDialog(g, function (t, e) {
                  d.showLinkDialog(v, t, e)
                })
            else if ('showImageDialog' === c)
              g.focus(),
                d.showImageDialog(
                  v,
                  function (t) {
            ...
            else if ('showVideoDialog' === c)
              g.focus(),
                a.setVideoDialog(g, function (t, e) {
              ...
              if (F)
                g.data('orgHeight', g.css('height')),
                  t(window).resize(x).trigger('resize')
              else {
                var S = !!g.data('optionHeight')
                g.css('height', S ? g.data('orgHeight') : 'auto'),
                  t(window).off('resize')
              }
              ...
              if (A) {
                if (
                  ...
                  var E = e.fromTextArea(
                    y[0],
                    t.extend(
                      { mode: 'text/html', lineNumbers: !0 },
                      h.data('options').codemirror
                    )
                  )
                  E.setSize(null, g.outerHeight()),
                    E.autoFormatRange &&
                      E.autoFormatRange(
                        { line: 0, ch: 0 },
                        {
                ...
                n.bCodeMirror && y.data('cmEditor').toTextArea(),
                  g.html(y.val() || i.emptyPara),
                  g.height(g.data('optionHeight') ? y.height() : 'auto'),
                  o.enable(b),
                  g.focus()
        ...
        z = function (e) {
          ...
          if (void 0 === e.offsetX) {
            ...
            n = { x: e.pageX - s.left, y: e.pageY - s.top }
          } else n = { x: e.offsetX, y: e.offsetY }
          var d = { c: Math.ceil(n.x / T) || 1, r: Math.ceil(n.y / T) || 1 }
          r.css({ width: d.c + 'em', height: d.r + 'em' }),
            i.attr('data-value', d.c + 'x' + d.r),
            3 < d.c && d.c < 10 && l.css({ width: d.c + 1 + 'em' }),
            3 < d.r && d.r < 10 && l.css({ height: d.r + 1 + 'em' }),
            o.html(d.c + ' x ' + d.r)
        },
        I = function (e) {
          var n = t(),
          ...
          t(document)
            .on('dragenter', function (t) {
              ...
              i ||
                ...
                a.width(e.editor.width()),
                a.height(e.editor.height()),
                o.text('Drag Image Here')),
                (n = n.add(t.target))
            })
            .on('dragleave', function (t) {
              ;(n = n.not(t.target)),
                0 === n.length && e.editor.removeClass('dragover')
            })
            .on('drop', function () {
      ...
      ;(this.attach = function (t, e) {
        t.editable.on('keydown', g),
          t.editable.on('mousedown', k),
          t.editable.on('keyup mouseup', w),
          t.editable.on('scroll', C),
          I(t),
          t.handle.on('mousedown', x),
          t.toolbar.on('click', S),
          t.popover.on('click', S),
          t.toolbar.on('mousedown', F),
          t.popover.on('mousedown', F),
          t.statusbar.on('mousedown', E)
        var n = t.toolbar,
          o = n.find('.note-dimension-picker-mousecatcher')
        o.on('mousemove', z),
          t.editable.on('blur', function () {
            a.saveRange(t.editable)
          }),
          e.onenter &&
            t.editable.keypress(function (t) {
              t.keyCode === v.ENTER && e.onenter(t)
            }),
          e.onfocus && t.editable.focus(e.onfocus),
          e.onblur && t.editable.blur(e.onblur),
          e.onkeyup && t.editable.keyup(e.onkeyup),
          e.onkeydown && t.editable.keydown(e.onkeydown),
          t.editable.data('callbacks', {
            onChange: e.onChange,
    ...
    m = function () {
      ...
      ;(e = {
        picture: function (t) {
          return (
            ...
            t.image.image +
            '" data-event="showImageDialog" tabindex="-1"><i class="editor-picture icon-picture"></i></button>'
          )
        },
        link: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.link.link +
            '" data-event="showLinkDialog" data-shortcut="Ctrl+K" data-mac-shortcut="⌘+K" tabindex="-1"><i class="editor-link icon-link"></i></button>'
          )
        },
        video: function (t) {
          return (
        ...
        style: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="' +
            t.style.style +
            '" data-toggle="dropdown" tabindex="-1"><i class="editor-text icon-magic"></i></span></button><ul class="dropdown-menu animated flipInY"><li><a data-event="formatBlock" data-value="p">' +
            t.style.normal +
            '</a></li><li><a data-event="formatBlock" data-value="blockquote"><blockquote>' +
            t.style.blockquote +
            '</blockquote></a></li><li><a data-event="formatBlock" data-value="pre">' +
            t.style.pre +
            '</a></li><li><a data-event="formatBlock" data-value="h1"><h1>' +
            t.style.h1 +
            '</h1></a></li><li><a data-event="formatBlock" data-value="h2"><h2>' +
            t.style.h2 +
            '</h2></a></li><li><a data-event="formatBlock" data-value="h3"><h3>' +
            t.style.h3 +
            '</h3></a></li><li><a data-event="formatBlock" data-value="h4"><h4>' +
            t.style.h4 +
            '</h4></a></li><li><a data-event="formatBlock" data-value="h5"><h5>' +
            t.style.h5 +
            '</h5></a></li><li><a data-event="formatBlock" data-value="h6"><h6>' +
            t.style.h6 +
            '</h6></a></li></ul>'
          )
        },
        ...
        color: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small dropdown-toggle" title="' +
            t.color.more +
            '" data-toggle="dropdown" tabindex="-1"><i class="editor-font icon-font"></i></button><ul class="dropdown-menu animated flipInY"><li><div class="btn-group"><div class="note-palette-title">' +
            t.color.background +
            '</div><div class="note-color-reset" data-event="backColor" data-value="inherit" title="' +
            t.color.transparent +
            '">' +
            t.color.setTransparent +
        ...
        bold: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.font.bold +
            '" data-shortcut="Ctrl+B" data-mac-shortcut="⌘+B" data-event="bold" tabindex="-1"><i class="editor-bold icon-bold"></i></button>'
          )
        },
        italic: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.font.italic +
            '" data-shortcut="Ctrl+I" data-mac-shortcut="⌘+I" data-event="italic" tabindex="-1"><i class="editor-italic icon-italic"></i></button>'
          )
        },
        underline: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.font.underline +
            '" data-shortcut="Ctrl+U" data-mac-shortcut="⌘+U" data-event="underline" tabindex="-1"><i class="editor-underline icon-underline"></i></button>'
          )
        },
        clear: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.font.clear +
            '" data-shortcut="Ctrl+\\" data-mac-shortcut="⌘+\\" data-event="removeFormat" tabindex="-1"><i class="editor-unstyle icon-eraser"></i></button>'
          )
        },
        ul: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.lists.unordered +
            '" data-shortcut="Ctrl+Shift+8" data-mac-shortcut="⌘+⇧+7" data-event="insertUnorderedList" tabindex="-1"><i class="editor-unlist icon-list-ul"></i></button>'
          )
        },
        ol: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.lists.ordered +
            '" data-shortcut="Ctrl+Shift+7" data-mac-shortcut="⌘+⇧+8" data-event="insertOrderedList" tabindex="-1"><i class="editor-orderlist icon-list-ol"></i></button>'
          )
        },
        paragraph: function (t) {
          return (
            ...
            '" data-toggle="dropdown" tabindex="-1"><i class="editor-align icon-align-left"></i></button><ul class="dropdown-menu animated flipInY"><li><div class="note-align btn-group"><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.paragraph.left +
            '" data-shortcut="Ctrl+Shift+L" data-mac-shortcut="⌘+⇧+L" data-event="justifyLeft" tabindex="-1"><i class="fa fa-align-left icon-align-left"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.paragraph.center +
            '" data-shortcut="Ctrl+Shift+E" data-mac-shortcut="⌘+⇧+E" data-event="justifyCenter" tabindex="-1"><i class="fa fa-align-center icon-align-center"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.paragraph.right +
            '" data-shortcut="Ctrl+Shift+R" data-mac-shortcut="⌘+⇧+R" data-event="justifyRight" tabindex="-1"><i class="fa fa-align-right icon-align-right"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.paragraph.justify +
            '" data-shortcut="Ctrl+Shift+J" data-mac-shortcut="⌘+⇧+J" data-event="justifyFull" tabindex="-1"><i class="fa fa-align-justify icon-align-justify"></i></button></div></li><li class="w-100 pull-left"><div class="note-list btn-group"><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.paragraph.outdent +
            '" data-shortcut="Ctrl+[" data-mac-shortcut="⌘+[" data-event="outdent" tabindex="-1"><i class="fa fa-outdent icon-indent-left"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.paragraph.indent +
            '" data-shortcut="Ctrl+]" data-mac-shortcut="⌘+]" data-event="indent" tabindex="-1"><i class="fa fa-indent icon-indent-right"></i></button></li></ul>'
          )
        },
        height: function (t) {
          return (
        ...
        help: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.options.help +
            '" data-shortcut="Ctrl+/" data-mac-shortcut="⌘+/" data-event="showHelpDialog" tabindex="-1"><i class="editor-help icon-question"></i></button>'
          )
        },
        fullscreen: function (t) {
          return (
            ...
            '" data-event="fullscreen" tabindex="-1"><i class="editor-full-screen icon-fullscreen"></i></button>'
          )
        },
        codeview: function (t) {
          return (
            '<button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.options.codeview +
            '" data-event="codeview" tabindex="-1"><i class="editor-code icon-code"></i></button>'
          )
        }
      }),
        (a = function (t) {
          return (
            '<div class="note-popover"><div class="note-link-popover popover bottom in" style="display: none;"><div class="arrow"></div><div class="popover-content note-link-content"><a href="http://www.google.com" target="_blank">www.google.com</a>&nbsp;&nbsp;<div class="note-insert btn-group"><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.link.edit +
            '" data-event="showLinkDialog" tabindex="-1"><i class="fa fa-edit icon-edit"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.link.unlink +
            '" data-event="unlink" tabindex="-1"><i class="fa fa-unlink icon-unlink"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.video.videoLink +
            '" data-event="showVideoDialog" tabindex="-1"><i class="fa fa-youtube-play icon-play"></i></button></div></div></div><div class="note-image-popover popover bottom in" style="display: none;"><div class="arrow"></div><div class="popover-content note-image-content"><div class="btn-group"><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.image.resizeFull +
            '" data-event="resize" data-value="1" tabindex="-1"><span class="note-fontsize-10">100%</span> </button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.image.resizeHalf +
            '" data-event="resize" data-value="0.5" tabindex="-1"><span class="note-fontsize-10">50%</span> </button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.image.resizeQuarter +
            '" data-event="resize" data-value="0.25" tabindex="-1"><span class="note-fontsize-10">25%</span> </button></div><div class="btn-group"><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.image.floatLeft +
            '" data-event="floatMe" data-value="left" tabindex="-1"><i class="fa fa-align-left icon-align-left"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.image.floatRight +
            '" data-event="floatMe" data-value="right" tabindex="-1"><i class="fa fa-align-right icon-align-right"></i></button><button type="button" class="btn btn-default btn-sm btn-small" title="' +
            t.image.floatNone +
            '" data-event="floatMe" data-value="none" tabindex="-1"><i class="fa fa-align-justify icon-align-justify"></i></button></div></div></div></div>'
          )
        }),
        (o =
      ...
      var s = function (t) {
          return (
            ...
            t.shortcut.textFormatting +
            '</th></tr></thead><tbody><tr><td>⌘ + B</td><td>' +
            t.font.bold +
            '</td></tr><tr><td>⌘ + I</td><td>' +
            t.font.italic +
            '</td></tr><tr><td>⌘ + U</td><td>' +
        ...
        c = function (t) {
          return (
            '<table class="note-shortcut"><thead><tr><th></th><th>' +
            t.shortcut.action +
            '</th></tr></thead><tbody><tr><td>⌘ + Z</td><td>' +
            t.history.undo +
            '</td></tr><tr><td>⌘ + ⇧ + Z</td><td>' +
            t.history.redo +
            '</td></tr><tr><td>⌘ + ]</td><td>' +
        ...
        u = function (t) {
          return (
            '<table class="note-shortcut"><thead><tr><th></th><th>' +
            t.shortcut.paragraphFormatting +
            '</th></tr></thead><tbody><tr><td>⌘ + ⇧ + L</td><td>' +
            t.paragraph.left +
            '</td></tr><tr><td>⌘ + ⇧ + E</td><td>' +
            t.paragraph.center +
            '</td></tr><tr><td>⌘ + ⇧ + R</td><td>' +
            ...
            '</td></tr><tr><td>⌘ + ⇧ + J</td><td>' +
            t.paragraph.justify +
            '</td></tr><tr><td>⌘ + ⇧ + NUM7</td><td>' +
            t.lists.ordered +
            '</td></tr><tr><td>⌘ + ⇧ + NUM8</td><td>' +
            t.lists.unordered +
            '</td></tr></tbody></table>'
          )
        },
        f = function (t) {
          return (
            '<table class="note-shortcut"><thead><tr><th></th><th>' +
            t.shortcut.documentStyle +
            '</th></tr></thead><tbody><tr><td>⌘ + NUM0</td><td>' +
            t.style.normal +
            '</td></tr><tr><td>⌘ + NUM1</td><td>' +
            t.style.h1 +
            '</td></tr><tr><td>⌘ + NUM2</td><td>' +
            t.style.h2 +
            '</td></tr><tr><td>⌘ + NUM3</td><td>' +
            t.style.h3 +
            '</td></tr><tr><td>⌘ + NUM4</td><td>' +
            t.style.h4 +
            '</td></tr><tr><td>⌘ + NUM5</td><td>' +
            t.style.h5 +
            '</td></tr><tr><td>⌘ + NUM6</td><td>' +
            t.style.h6 +
            '</td></tr></tbody></table>'
          )
        },
      ...
      ;(r = function (t) {
        return (
          '<div class="note-dialog"><div class="note-image-dialog modal" aria-hidden="false"><div class="modal-dialog animated bounceIn"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">×</button><h4 class="modal-title">' +
          t.image.insert +
          '</h4></div><div class="modal-body"><div class="row-fluid"><div class="m-b-5">' +
          t.image.selectFromFiles +
          '</div><div class="fileupload fileupload-new" data-provides="fileupload"><span class="btn btn-file btn-sm"><span class="fileupload-new">Select file</span><span class="fileupload-exists">Change</span><input class="note-image-input" type="file" name="files" accept="image/*" /></span><span class="fileupload-preview"></span><a href="" class="close close-pic fileupload-exists" data-dismiss="fileupload"><i class="fa fa-times"></i></a></div><div class="m-b-5">' +
          t.image.url +
          '</div><input class="note-image-url form-control input-sm span12" type="text" /></div></div><div class="modal-footer"><button href="" class="btn btn-primary note-image-btn disabled" disabled="disabled">' +
          t.image.insert +
          '</button></div></div></div></div><div class="note-link-dialog modal" aria-hidden="false"><div class="modal-dialog animated bounceIn"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">×</button><h4 class="modal-title">' +
          t.link.insert +
          '</h4></div><div class="modal-body"><div class="row-fluid"><div class="form-group"><label>' +
          t.link.textToDisplay +
          '</label><span class="note-link-text form-control input-xlarge uneditable-input" /></div><div class="form-group"><label>' +
          t.link.url +
          '</label><input class="note-link-url form-control span12" type="text" /></div></div></div><div class="modal-footer"><button href="" class="btn btn-primary note-link-btn disabled" disabled="disabled">' +
          t.link.insert +
          '</button></div></div></div></div><div class="note-video-dialog modal" aria-hidden="false"><div class="modal-dialog animated bounceIn"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">×</button><h4 class="modal-title">' +
          t.video.insert +
          '</h4></div><div class="modal-body"><div class="row-fluid"><div class="form-group"><label>' +
          t.video.url +
          '</label>&nbsp;<small class="text-muted">' +
          t.video.providers +
          '</small><input class="note-video-url form-control span12" type="text" /></div></div></div><div class="modal-footer"><button href="" class="btn btn-primary note-video-btn disabled" disabled="disabled">' +
          t.video.insert +
          '</button></div></div></div></div><div class="note-help-dialog modal" aria-hidden="false"><div class="modal-dialog animated bounceIn"><div class="modal-content"><div class="modal-body"><div class="modal-background"><a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' +
          t.shortcut.close +
          '</a><div class="title">' +
          t.shortcut.shortcuts +
          '</div>' +
          (n.bMac ? h(t) : b(h(t))) +
          '<p class="text-center"><a href="//hackerwins.github.io/summernote/" target="_blank">Summernote 0.5.0</a> · <a href="//github.com/HackerWins/summernote" target="_blank">Project</a> · <a href="//github.com/HackerWins/summernote/issues" target="_blank">Issues</a></p></div></div></div></div></div>'
        )
      }),
        (l =
      ...
      var v = function (e, a) {
          e.find('button')
            .each(function (e, a) {
              ...
              i &&
                o.attr('title', function (t, e) {
                  return e + ' (' + i + ')'
                })
            })
            .tooltip({ container: 'body', placement: a || 'top' })
        },
        m = [
          [
            '#000000',
      ...
      this.createLayout = function (n, s) {
        ...
        if (!n.next().hasClass('note-editor')) {
          ...
          b.data('options', s),
            c > 0 &&
              t('<div class="note-statusbar">' + l + '</div>').prependTo(b)
          var m = t(
            '<div class="note-editable overflow" contentEditable="true"></div>'
          ).prependTo(b)
          c && (m.height(c), m.data('optionHeight', c)),
            u && m.data('tabsize', u),
            m.html(i.html(n) || i.emptyPara),
            m.data('NoteHistory', new d()),
            t('<textarea class="note-codable"></textarea>').prependTo(b),
            setTimeout(function () {
  ...
  ;(t.summernote = t.summernote || {}),
    ...
    t.fn.extend({
      ...
      code: function (e) {
        if (void 0 === e) {
          ...
          if (o && o.editable) {
            ...
            return (
              i && n.bCodeMirror && o.codable.data('cmEditor').save(),
              i ? o.codable.val() : o.editable.html()
            )
          }
          return a.html()
        }
      ...
      summernoteInner: function () {
        return { dom: i, list: o, func: a, range: r }
      }
    })
})
