...
var allMData = {
  ...
  variety: [
    25.1, 24.3, 24.6, 25.4, 28.7, 29.5, 23.2, 21.9, 23.8, 20.6, 27.3, 25.7
  ],
  maYang: [
    28340, 28352, 29437, 30254, 31061, 30356, 30243, 29009, 27356, 28342, 27329,
    31358
  ],
  stock: [
    12710, 13402, 12568, 14002, 14073, 13368, 13914, 11467, 13479, 13321, 12465,
    12020
  ]
}
...
function render(index) {
  ...
  $('.publish img').remove()
  $('.publish').append(
    '<img src="./img/' + myData.ClouImg + '" alt="更多资源：">'
  )
}
  ...
  timer = setInterval(function () {
    ...
    if (mapChart.currentIndex === hasData.length - 1) {
      ...
      oldBData =
        monthIndex == 0
          ? allMData['book'][11]
          : allMData['book'][monthIndex - 1]

      newVData = allMData['variety'][monthIndex]
      oldVData =
        monthIndex == 0
          ? allMData['variety'][11]
          : allMData['variety'][monthIndex - 1]

      newMData = allMData['maYang'][monthIndex]
      oldMData =
        monthIndex == 0
          ? allMData['maYang'][11]
          : allMData['maYang'][monthIndex - 1]

      newSData = allMData['stock'][monthIndex]
      oldSData =
        monthIndex == 0
          ? allMData['stock'][11]
          : allMData['stock'][monthIndex - 1]
