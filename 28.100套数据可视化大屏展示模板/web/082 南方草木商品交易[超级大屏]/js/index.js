...
$('.liushuihaoul .moveul').css(
  'height',
  $('.liushuihaoul .moveul').find('li').length * 50
)
...
;(function () {
  ...
  let time =
    adata.getHours() +
    ':' +
    Fill(adata.getMinutes()) +
    ':' +
    Fill(adata.getSeconds())
  let year =
    adata.getFullYear() +
    '年' +
    (adata.getMonth() + 1) +
    ...
    series: [
      {
        ...
        smooth: false, //折线是否平滑
        data: [
          1300, 1300, 1300, 1300, 1190, 800, 900, 1000, 1200, 1000, 900, 850
        ]
      },
      {
        name: '一年生冷季牧草',
        ...
        data: [
          1220, 1220, 1220, 1220, 1100, 720, 820, 920, 1000, 1200, 1500, 1300
        ]
      },
      {
        name: '多年生牧草',
...
;(function () {
  ...
  $('.huiYuanLst .moveul').css(
    'height',
    $('.huiYuanLst .moveul').find('li')[0].offsetHeight * 35
  )
