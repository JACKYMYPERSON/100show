      ...
      success: function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
          ;(function (x) {
            ...
            var info =
              '<div style="width: 200px;height: 160px;background-color: rgba(13, 33, 70, 0.8);border: 1px solid #155596; padding: 12px 0 20px 35px;box-sizing: border-box; position: relative; border-bottom: none;">\n' +
              ...
              '        </div>\n' +
              '        <img src="./img/jiantou.png" alt="更多资源：" style="display: blolk;position: absolute;bottom: -13px ;right: 0;">\n' +
              '    </div>'
