    ...
    let LineData = [
      {
        name: '破损件',
        data: [
          5, 12, 3, 23, 4, 21, 12, 34, 23, 13, 45, 5, 12, 3, 23, 4, 21, 12, 34,
          23, 13, 45, 3, 23, 4, 21, 12, 34
        ],
        color: ['#2773fa', '#051f48']
      },
      {
        name: '丢失件',
        data: [
          15, 2, 13, 20, 14, 20, 11, 24, 21, 33, 12, 2, 12, 42, 5, 6, 4, 15, 31,
          23, 11, 22, 5, 33, 14, 31, 22, 14
        ],
        color: ['#14c3fc', '#022536']
      },
      {
        name: '损坏件',
        data: [
          12, 32, 32, 33, 11, 1, 33, 2, 23, 12, 35, 2, 13, 22, 23, 34, 12, 34,
          11, 22, 12, 11, 23, 12, 22, 13, 12, 23
        ],
        color: ['#5deefe', '#01323a']
      },
      {
        name: '拒收件',
        data: [
          6, 2, 23, 12, 22, 21, 12, 23, 12, 44, 12, 22, 13, 23, 11, 12, 23, 45,
          12, 5, 23, 12, 14, 23, 13, 23, 45, 12
        ],
        color: ['#fff369', '#353910']
      },
      {
        name: '未签收',
        data: [
          16, 22, 13, 22, 32, 11, 22, 12, 34, 11, 23, 12, 23, 12, 34, 11, 23,
          23, 12, 23, 12, 34, 11, 22, 11, 22, 12, 23
        ],
        color: ['#ffaf48', '#0f1e21']
      }
    ]
